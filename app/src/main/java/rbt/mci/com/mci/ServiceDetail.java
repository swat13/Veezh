...
public class ServiceDetail extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        accDetailFeed = (RSSFeed) getIntent().getSerializableExtra("serviceDetail");
        accImageFeed = (RSSFeed) getIntent().getSerializableExtra("serviceImage");
        ...
        Picasso.with(getApplicationContext())
                .load("http://www.veezh.com/upload/service/" + accDetailFeed.getItem(0).getThumb() + ".jpg")
