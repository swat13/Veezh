...
public class DOMParser {
    ...
    public RSSFeed getVipOffer() {

        HttpURLConnection httpConn = null;
        try {
            RSSFeed _feed = new RSSFeed();
            URL url = new URL(mainUrl + "vizheh.php");
            httpConn = (HttpURLConnection) url.openConnection();
            httpConn.setAllowUserInteraction(false);
            httpConn.setInstanceFollowRedirects(true);
            httpConn.setRequestMethod("POST");
    ...
    public RSSFeed getCityList() {

        HttpURLConnection httpConn = null;
        try {
            RSSFeed _feed = new RSSFeed();
            URL url = new URL(mainUrl + "ostan.php");
            httpConn = (HttpURLConnection) url.openConnection();
            httpConn.setAllowUserInteraction(false);
            httpConn.setInstanceFollowRedirects(true);
            httpConn.setRequestMethod("POST");
    ...
    public RSSFeed getAdImages(String id) {

        HttpURLConnection httpConn = null;
        try {
            RSSFeed _feed = new RSSFeed();
            URL url = new URL(mainUrl + "img.php?id=" + id);
            httpConn = (HttpURLConnection) url.openConnection();
            httpConn.setAllowUserInteraction(false);
            httpConn.setInstanceFollowRedirects(true);
            httpConn.setRequestMethod("POST");
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                RSSItem _items = new RSSItem();
                JSONObject jsonObject0 = jsonArray.getJSONObject(i);
                _items.setImage(jsonObject0.getString("Src"));
                _feed.addItem(_items);
            }
